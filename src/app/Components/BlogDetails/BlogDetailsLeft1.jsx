                    ...
                    <div className="comment-box">
                      <div className="box-top-area">
                        <div className="heading-area">
                          <div className="image">
                            <Image
                              src="/assets/img/blog/comment-box-image1.png"
                              alt="img"
                              width={70}
                              height={70}
                            />
                      ...
                      <div className="space20"></div>
                      <p className="pera">
                        The team at Adverse Media goes above and beyond to
                        provide exceptional support and service. From the
                        initial consultation to the final deployment, they were
                        there every step of the way, ensuring a seamless
                        integration of our new technology solution.
                      </p>
                    </div>
                    ...
                    <div className="comment-box comment-box2">
                      <div className="box-top-area">
                        <div className="heading-area">
                          <div className="image">
                            <Image
                              src="/assets/img/blog/comment-box-image2.png"
                              alt="img"
                              width={70}
                              height={70}
                            />
                      ...
                      <div className="space20"></div>
                      <p className="pera">
                        We approached Adverse Media with a complex IT problem,
                        and they were able to provide an innovative solution
                        that addressed our needs perfectly. Their teams
                        creativity, technical prowess, and dedication to client
                        satisfaction are truly commendable.
                      </p>
                    </div>
                  </div>
                </div>
