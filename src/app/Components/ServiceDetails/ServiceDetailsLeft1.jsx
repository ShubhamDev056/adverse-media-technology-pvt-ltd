            ...
            <div className="service-details-post">
              <article>
                <div className="details-post-area">
                  <div className="image">
                    <Image
                      src="/assets/img/service/service-details-img.png"
                      alt="img"
                      width={838}
                      height={503}
                    />
                  ...
                  <div className="heading1">
                    ...
                    <p>
                      Welcome to Adverse Media IT Solutions, your premier
                      destination for comprehensive software development
                      services tailored to meet your business needs. Our team of
                      experienced developers is dedicated to delivering
                      high-quality, scalable, and innovative software solutions
                      that drive business growth success.
                    </p>
                  </div>
                </div>
              </article>
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <div className="heading1">
                        ...
                        <div className="space16"></div>
                        <p>
                          At Adverse Media IT Solutions, we take a
                          client-centric approach to software development,
                          prioritizing your unique requirements and objectives.
                          Our process begins with a thorough understanding of
                          your business goals, target audience, and technical
                          specifications. We then collaborate closely with you
                          at every stage of the development cycle to ensure that
                    ...
                    <div className="col-lg-6">
                      ...
                      <div className="heading1">
                        ...
                        <div className="space20"></div>
                        <p>
                          From initial concept and design to development,
                          testing, and deployment, we offer comprehensive
                          full-cycle development services to ensure a seamless
              ...
              <article>
                <div className="details-post-area">
                  <div className="heading1">
                    ...
                    <div className="space16"></div>
                    <p>
                      At Adverse Media IT Solutions, we take a client-centric
                      approach to software development, prioritizing your unique
                      requirements and objectives. Our process begins with a
                      thorough understanding of your business goals, target
                      audience, and technical specifications. We then
                      collaborate closely with you at every stage of the
                      development cycle to ensure that the final product exceeds
                      your expectations.
                    </p>
                    ...
                    <ul className="expart-list">
                      ...
                      <li>
                        ...
                        <span className="text">Backend:</span> (Node.js, Python,
                        Ruby on Rails, PHP, .NET)
                      </li>
                      <li>
                        <span className="check">
                          <i className="bi bi-check-lg"></i>
                      ...
                      <li>
                        ...
                        <span className="text">Mobile:</span> (iOS (Swift),
                      ...
                      <li>
                        ...
                        <span className="text">Cloud Platform:</span> (AWS,
                ...
                <div className="col-lg-6 col-md-6">
                  <div className="">
                    <div className="servcie2-box servcie2-box-2">
                      ...
                      <Link href="/service/service-details" className="arrow">
                        <i className="bi bi-arrow-right"></i>
                      </Link>
                      <div className="heading1">
                        <h4>
                        ...
                        <div className="space16"></div>
                        <p>
                          Strategic IT planning roadmap development Business
                          process analysis and improvement for It solution &
                          technology.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="">
                    <div className="servcie2-box servcie2-box-2">
                      ...
                      <div className="heading1">
                        ...
                        <div className="space16"></div>
                        <p>
                          Mobile app development for iOS, Android, and
                          cross-platform solutions & web <br /> application.
                        </p>
                      </div>
                    </div>
                  </div>
